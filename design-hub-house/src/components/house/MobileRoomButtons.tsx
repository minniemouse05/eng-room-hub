...
export function MobileRoomButtons() {
  return (
    <div className="lg:hidden space-y-4 mt-8">
      <h2 className="text-lg font-semibold text-center text-off-white/60">
              ...
              <div className="flex items-center gap-4">
                ...
                <div
                  ...
                  style={{
                    ...
                    boxShadow: `0 0 15px ${room.color}20`,
                  }}
                >
                  <span
                    className="text-2xl"
                    style={{ filter: `drop-shadow(0 0 6px ${room.color}60)` }}
                  >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-off-white/60 line-clamp-1">
                    {room.description}
                  </p>
                </div>
